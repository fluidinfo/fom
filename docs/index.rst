...
Fom is a library for accessing FluidDB (http://fluidinfo.com). The name Fluid Object Mapper is meant to reflect the similarity between this and ORM software.
